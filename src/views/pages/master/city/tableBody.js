                ...
                data.map((row, key) => {
                    return (
                        <TableRow hover role="checkbox" sx={{ padding: -4 }} tabIndex={-1} key={row.id}>
                            ...
                            <TableCell size="small">{row.province ?? ''}</TableCell>
                            <TableCell size="small">{row.island ?? ''}</TableCell>
                            <TableCell size="small">{row.country === "Indonesia" ? 'Tidak' : 'Ya'}</TableCell>
                            <TableCell size="small">{row.latitude ?? ''}</TableCell>
                            <TableCell size="small">{row.longitude ?? ''}</TableCell>

...
import { storeReportSaleCashiers, storeMemberSelect, storeWarehouseSelect, storeUserSelect } from 'services/endPoint';
...
const ReportSaleCashiers = () => {
    ...
    const { useGet: getSaleCashier, data: dataSaleCashier } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getSaleCashier(storeReportSaleCashiers, { ...filter, limit: 10000 });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Penjualan Kasir">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                ...
                <DialogContent>
                    <TableReport data={dataSaleCashier} filter={filter} typeReport={typeReport} isloading={isloading} />
                    {isloading ? (
                        <>
...
export default ReportSaleCashiers;

...
import { storeReportSale, storeMemberSelect, storeWarehouseSelect, storeUserSelect } from 'services/endPoint';
...
const ReportSales = () => {
    ...
    const { useGet: getSale, data: dataSale } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getSale(storeReportSale, { ...filter, limit: 10000 });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Penjualan">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                ...
                <DialogContent>
                    <TableReport data={dataSale} filter={filter} typeReport={typeReport} />
                    {isloading ? (
                        <>

        ...
        <TableContainer component={Paper}>
            <Table aria-label="sticky table" sx={{ minWidth: 1200 }}>
                ...
                <TableBody>
                    {data &&
                        data.map((value, key) => {
                            footer[0].value += parseFloat(value.returnQuantity) ?? 0;
                            ...
                            return (
                                <>
                                    <TableRow>
                                        ...
                                        <TableCell>{value?.sale_return?.invoice ?? ''}</TableCell>
                                        ...
                                        <TableCell>{value?.sale_return?.member?.name ?? ''}</TableCell>
                                        <TableCell>{value?.unit_conversion?.unit?.name ?? ''}</TableCell>
                                        <TableCell align="right">{money.format(value?.returnQuantity ?? 0)}</TableCell>

...
const ReportSalesOrderPerItems = () => {
    ...
    const { useGet: getSalesOrderPerItems, data: dataSalesOrderPerItems } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getSalesOrderPerItems(storeReportSalesOrderPeritems, { ...filter, limit: 100000 });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Pesanan Penjualan Per Item">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                <DialogTitle sx={{ width: '100%' }} id="alert-dialog-title" style={{ fontSize: 16 }}>
                    Laporan Pesanan Penjualan Peritem
                </DialogTitle>
                <DialogContent>
                    <TableReport data={dataSalesOrderPerItems} filter={filter} typeReport={typeReport} isloading={isloading} />
                    {isloading ? (
                        <>
...
export default ReportSalesOrderPerItems;

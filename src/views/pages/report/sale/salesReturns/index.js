...
import { storeReportSaleReturns, storeMemberSelect, storeWarehouseSelect, storeUserSelect, storeItemSelect } from 'services/endPoint';
...
const ReportSaleReturns = () => {
    ...
    const { useGet: getSaleReturns, data: dataSaleReturns } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getSaleReturns(storeReportSaleReturns, { ...filter });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Retur Penjualan">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                ...
                <DialogContent>
                    <TableReport data={dataSaleReturns} filter={filter} typeReport={typeReport} isloading={isloading} />
                    {isloading ? (
                        <>
...
export default ReportSaleReturns;

...
import { storeReportPurchaseReturns, storeSupplierSelect, storeWarehouseSelect, storeUserSelect, storeItemSelect } from 'services/endPoint';
...
const ReportPurchaseReturns = () => {
    ...
    const { useGet: getPurchaseReturns, data: dataPurchaseReturns } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getPurchaseReturns(storeReportPurchaseReturns, { ...filter });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Retur Pembelian">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                ...
                <DialogContent>
                    <TableReport data={dataPurchaseReturns} filter={filter} typeReport={typeReport} />
                    {isloading ? (
                        <>
...
export default ReportPurchaseReturns;

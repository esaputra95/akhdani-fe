...
import { storeReportPurchase, storeSupplierSelect, storeWarehouseSelect, storeUserSelect } from 'services/endPoint';
...
const ReportPurchases = () => {
    ...
    const { useGet: getPurchase, data: dataPurchase } = useFetch();
    ...
    const handleOpen = async () => {
        ...
        await getPurchase(storeReportPurchase, { ...filter });
        setIsLoading(false);
    };
    ...
    return (
        <MainCard title="Laporan Pembelian">
            <FilterReport
            ...
            <Dialog maxWidth="xl" open={openDialog} onClose={handleOpen} style={{ overflow: 'auto' }}>
                ...
                <DialogContent>
                    <TableReport data={dataPurchase} filter={filter} typeReport={typeReport} />
                    {isloading ? (
                        <>
